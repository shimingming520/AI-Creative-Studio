...
export function buildVideoModelMenuHTML({
  ...
  const _0x2ca8ab = _0x123fd0.includes(String(activeModel || "").trim()) ? String(activeModel || "").trim() : _0x123fd0[0] || String(activeModel || "").trim() || getDefaultRunningHubVideoWorkflowModelId();
  ...
  if (_0x123fd0.length) {
    ...
    const _0x44f004 = _0x2cb693.map(_0x1ec8e3 => ({
...
export function renderVideoModelTriggerIconHTML({
  ...
  if (_0x35e7ef && /^custom_[a-z0-9_-]+$/i.test(_0x35e7ef)) {
